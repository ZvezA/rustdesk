...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("AgatDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["2.26.143.6"];
pub const RS_PUB_KEY: &str = "Qo8Ms2Om6CbX1ctmrIwaP4TnBGVgpkzTaOjnybDYXTo=";
